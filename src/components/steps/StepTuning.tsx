...
const StepTuning: React.FC<StepTuningProps> = ({ onNext }) => {
  const [tuningNotes, setTuningNotes] = useState<TuningNote[]>([
    { name: 'Low E (6th string)', frequency: 82.41, isInTune: false },
    { name: 'A (5th string)', frequency: 110.00, isInTune: false },
    { name: 'D (4th string)', frequency: 146.83, isInTune: false },
    { name: 'G (3rd string)', frequency: 196.00, isInTune: false },
    { name: 'B (2nd string)', frequency: 246.94, isInTune: false },
    { name: 'High E (1st string)', frequency: 329.63, isInTune: false },
  ]);
